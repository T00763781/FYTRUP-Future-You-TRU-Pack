...
<svelte:head>
  ...
  <!-- SAFE MANIFEST PATH (no SSR crash) -->
...
<style>
  ...
  .layer-header { position: absolute; top: 0; width: 100%; z-index: 30; }
  ...
  .layer-splash { position: absolute; inset: 0; z-index: 40; }
